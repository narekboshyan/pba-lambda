...
export declare class CfnDBInstance extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggable {
     ...
     */
    statusInfos?: Array<CfnDBInstance.DBInstanceStatusInfoProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
...
export interface CfnDBInstanceProps {
     ...
     */
    readonly statusInfos?: Array<CfnDBInstance.DBInstanceStatusInfoProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A value that indicates whether the DB instance is encrypted. By default, it isn't encrypted.
     *
     * If you specify the `KmsKeyId` property, then you must enable encryption.
